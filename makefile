...
cTrace: bin/Session.o bin/Agent.o bin/Tree.o bin/Graph.o bin/main.o bin/ContactTracer.o bin/CycleTree.o bin/MaxRankTree.o bin/RootTree.o bin/Virus.o 
	@echo 'Building target: cTrace'
	@echo 'Invoking: C++ Linker'
	g++ -o bin/Session.o bin/Agent.o bin/Tree.o bin/Graph.o bin/main.o bin/ContactTracer.o bin/CycleTree.o bin/MaxRankTree.o bin/RootTree.o bin/Virus.o
